...
from pointnet2_utils_ours import *

class get_model(nn.Module):
    def __init__(self,num_class,num_point,normal_channel=True):
        super(get_model, self).__init__()
        in_channel = 6 if normal_channel else 3
        self.normal_channel = normal_channel
        self.sa1 = PointNetSetAbstraction(npoint=num_point//2, radius=0.2, nsample=num_point//32, in_channel=in_channel, mlp=[64*2, 64*2, 128], group_all=False, layer='1')
        self.sa2 = PointNetSetAbstraction(npoint=num_point//4, radius=0.4, nsample=num_point//16, in_channel=128, mlp=[128, 128, 256], group_all=False, layer='2')
